...
class Movies extends MY_Controller {
    ...
    public function create() {
        ...
        if($this->input->post('slug') && $this->input->post('name') && $this->input->post('descriptions') && $this->input->post('
            ...
            if($this->Films_model->setMovies($slug, $name, $descriptions, $year, $rating, $poster, $player_code, $director, $
    ...
    public function delete($slug = NULL) {
        ...
        $tihs->data['movies_delete'] = $this->Films_model->getMovies($slug);
        ...
        $this->['result'] = "Ошибка удаления".$this->data['movies_delete']['name'];
    ...
    public function comment() {
        ...
        if($this->input->post('user_id') && $this->input->post('movie_id') && $this->input->post('comment_text')) {
            ...
            if($this->Films_model->setComments($user_id, $move_id, $comment_text)) {
