...
class Films_model extends CI_Model {
    ...
    public function setMovies($slug, $name, $descriptions, $year, $rating, $poster, $player_code, $director, $add_date, 
        $category_id) {
            $data = array(
                'slug' => $slug,
                'name' => $name,
    ...
    public function updateMovies($id, $slug, $name, $descriptions, $year, $rating, $poster, $player_code, $director, $add_date,
        $category_id) {
        $data = array(
            'id' => $id,
            'slug' => $slug,
